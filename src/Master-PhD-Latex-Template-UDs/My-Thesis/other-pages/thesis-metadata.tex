...
\newcommand{\thesisSupervisorTitle}{Maitre de Conf\'erences, Universit\'e de Dschang}
...
\newcommand{\thesisTitleFr}{%
  ...
  \\[0.15em] \'etude de cas sur la d\'etection des PFAS et l'\'evaluation des risques%
}
