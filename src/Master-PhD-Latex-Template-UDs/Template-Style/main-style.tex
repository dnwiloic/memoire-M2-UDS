...
%
% Ce fichier prolonge le corps dans My-Thesis/My-Thesis.tex ; ne pas le compiler seul.
% !TEX root = ../My-Thesis/My-Thesis.tex
...
\usepackage{amsmath}
\usepackage{graphicx}
% pst-all fait partie de texlive-pstricks (\texttt{sudo apt install texlive-pstricks}); non utilis� dans ce d�p�t
%\usepackage{pst-all}
\usepackage{verbatim} 
